...
SECRET_KEY = 'django-insecure-m0o2hm13*^jy9)bpt19z@-ee4*e#gy%u+lf#tbobu0ex5a&5kw'
...
REST_KNOX = {
    ...
    'TOKEN_TTL': timedelta(minutes=30), # The default is 10 hours i.e., timedelta(hours=10)).
